function Cenario(riverRaid) {
    ...
    Cenario.largura = Math.floor(riverRaid.canvas.width /
        this.colunasPorTela);
    riverRaid.canvas.height = Math.floor(riverRaid.canvas.height /
        Cenario.largura) * Cenario.largura;
    riverRaid.canvas.width = Math.floor(riverRaid.canvas.width /
        Cenario.largura) * Cenario.largura;
    this.linhasPorTela = Math.floor(riverRaid.canvas.height /
        Cenario.largura);
            ...
            for (var xm = 0; xm < this.colunasPorTela; xm++) {
                switch (this.getPosicaoMapa(xm, ym)) {
                    case Cenario.terra:
                        ...
                        ctx.fillRect(this.matrizParaPixelX(xm), this.matrizParaPixelY(ym,
                            true), Cenario.largura, Cenario.largura);
                        break;
                        ...
                        this.matrizParaPixelY = function(my, calcDif) {
                            ...
                            return ((this.linhasPorTela - 1) - my) * Cenario.largura + dif *
                                Cenario.largura;
                        };
